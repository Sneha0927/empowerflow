...
export function EmployeeForm({ employee }: EmployeeFormProps) {
  ...
  const [formData, setFormData] = useState<EmployeeFormData>({
    ...
    date_of_birth: employee?.date_of_birth ? (typeof employee.date_of_birth === 'string' ? employee.date_of_birth.split("T")[0] : employee.date_of_birth) : "",
    department: employee?.department || "",
    position: employee?.position || "",
    salary: employee?.salary || 0,
    onboarding_date: employee?.onboarding_date ? (typeof employee.onboarding_date === 'string' ? employee.onboarding_date.split("T")[0] : employee.onboarding_date) : "",
